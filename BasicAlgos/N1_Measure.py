...
def Optimize(X_train, y_train):
    ...
    def kmeans_n1(k):
        return KMeans_N1(k=int(k), X_train=X_train)
    def birch_n1(k):
        return Birch_N1(k=int(k), X_train=X_train)
    def gmm_n1(k):
        return GMM_N1(k=int(k), X_train=X_train)
    def bis_kmeans_n1(k):
        return Bis_KMeans_N1(k=int(k), X_train=X_train)
    ...
    for i in range(len(Cluster_Methods)):
        ...
        df_res.loc[i,'Cluster_Method'] = Cluster_Methods[i]+'_N1'
