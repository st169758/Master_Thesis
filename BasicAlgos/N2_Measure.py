...
def Optimize(X_train, y_train):
    ...
    def kmeans_n2(k):
        return KMeans_N2(k=int(k), X_train=X_train)
    def birch_n2(k):
        return Birch_N2(k=int(k), X_train=X_train)
    def gmm_n2(k):
        return GMM_N2(k=int(k), X_train=X_train)
    def bis_kmeans_n2(k):
        return Bis_KMeans_N2(k=int(k), X_train=X_train)
    ...
    for i in range(len(Cluster_Methods)):
        ...
        df_res.loc[i,'Cluster_Method'] = Cluster_Methods[i]+'_N2'
